...
public class X509Filter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ModifyHeaderServletRequestWrapper wrappedRequest = new ModifyHeaderServletRequestWrapper((HttpServletRequest) request);
    ...
    private void configureUserId(ModifyHeaderServletRequestWrapper wrappedRequest) throws ServletException {
...
//        }
    ...
    private void configureUserRole(ModifyHeaderServletRequestWrapper wrappedRequest) throws ServletException {
