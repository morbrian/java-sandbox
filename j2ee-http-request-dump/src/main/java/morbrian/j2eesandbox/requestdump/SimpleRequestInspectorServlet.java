...
public class SimpleRequestInspectorServlet extends javax.servlet.http.HttpServlet {
    ...
    private void inspectRequest(HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, IOException {
