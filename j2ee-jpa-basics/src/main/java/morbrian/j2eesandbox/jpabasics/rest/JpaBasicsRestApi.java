...
@Path("/document") @RequestScoped public class JpaBasicsRestApi {

  @Inject DocumentPersistence documentPersistence;
  @Inject DigestController controller;
  @Inject private Logger log;
  @Inject private DocumentRepository documentRepo;

  @GET @Path("/raw") @Produces(MediaType.APPLICATION_JSON)
  ...
  @GET @Path("/derived/{docid}") @Produces(MediaType.APPLICATION_JSON)
  ...
  @GET @Path("/fetch/data") @Produces(MediaType.APPLICATION_JSON)
